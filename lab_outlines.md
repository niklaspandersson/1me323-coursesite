...
*Tone & Style:* Instruerande, utforskande, med "Dölj/Visa"-lösningar och reflektionsfrågor.

---

## Vecka 1: Moduler & Versionshantering
*Fokus: Komma igång med modern JS-struktur och versionshantering lokalt.*
...
*Fokus: Datastrukturer och persistering.*

### Lab 2-a: "Objekt-verkstaden"
...
### Lab 2-c: "Kom ihåg mig" (localStorage)
...
*Fokus: Klasser för struktur och inkapsling (ej arv).*

### Lab 4-a: "Classy Shapes"
...
### Lab 4-b: "The Bank Account" (Encapsulation)
...
### Lab 4-c: "Smart Components"
*   **Syfte:** Praktisk användning av klasser i UI.
*   **Övningar:**
    1.  Skapa en klass `ProductCard` som tar in `data` (titel, pris, bild) i konstruktorn.
    2.  Skapa en metod `render()` som returnerar en HTML-sträng eller ett DOM-element.
    3.  Skapa en array med produkt-data, loopa igenom den, skapa instanser av `ProductCard` och rendera till sidan.
*   **Utmaning:** Lägg till en metod `bindEvents()` i klassen som hanterar klick på "Köp"-knappen inuti kortet.

---

## Vecka 5: DOM Scripting & Responsivitet
*Fokus: Dynamisk länkning mellan logik och vy.*
...
## Vecka 7: Formulär
*Fokus: Interaktion och validering.*
